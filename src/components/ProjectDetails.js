...
const ProjectDetails = () => {
    ...
    useEffect(() => {
        const fetchProject = async () => {
            const response = await fetch('https://fyp-backup-test.herokuapp.com/api/project/' + id, { // fetch the project based on the project's id
                headers: {
    ...
    const handleClick = async () => {
        const response = await fetch('https://fyp-backup-test.herokuapp.com/api/project/' + id, {
            method: 'DELETE',
            headers: {
    ...
    const handleCloseProject = async () => {
        const response = await fetch('https://fyp-backup-test.herokuapp.com/api/assignment/closeProject/' + id, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${ user.token }`
            }
