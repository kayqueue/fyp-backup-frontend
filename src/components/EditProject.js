...
const EditProject = () => {
    ...
    useEffect(() => {
        ...
        //     const response = await fetch('https://fyp-backup-test.herokuapp.com/api/skill/', {
        //         headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        // update data
        const response = await fetch('https://fyp-backup-test.herokuapp.com/api/project/editproject/' + id, {
            method: 'PATCH',
