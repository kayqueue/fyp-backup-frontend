...
const OrganisationDetails = () => {
    ...
    useEffect(() => {
        const fetchOrganisation = async () => {
            const response = await fetch('https://fyp22s432.herokuapp.com/api/organisation/' + id, { // fetch the project based on the project's id
                headers: {
    ...
    const handleClick = async () => {
        const response = await fetch('https://fyp22s432.herokuapp.com/api/organisation/' + id, {
            method: 'DELETE',
            headers: {
